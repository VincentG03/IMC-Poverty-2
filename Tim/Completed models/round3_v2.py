...
class Product:
    AMETHYSTS = "AMETHYSTS" #RESIN
    STARFRUIT = "STARFRUIT" #KELP
    ORCHIDS = "ORCHIDS"
...
class Trader:
    def __init__(self, params=None):
        ...
        self.LIMIT = {
            Product.AMETHYSTS: 20, #RESIN
            Product.STARFRUIT: 20, #KELP
            Product.ORCHIDS: 100, #We donT FUCK WITH ORCHIDS
            Product.GIFT_BASKET: 60, #PICNICBASKET1
            Product.CHOCOLATE: 250, #CROISSANTS
            Product.STRAWBERRIES: 350, #JAM
            Product.ROSES: 60, #DEJEMBES 
        }
